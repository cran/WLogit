...
$\boldsymbol{\beta}$ are equal to 1.
...
##  Estimation of $\boldsymbol{\beta}$ by $\widehat{\boldsymbol{\beta}}(\lambda)$ which minimizes the Log-likelihood
